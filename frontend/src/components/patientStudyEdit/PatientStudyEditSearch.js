...
function noop() {
  // intentional no-op default prop
}

const PatientStudyEditSearch = ({
      ...
      {searchCompleted && searchResultRows.length > 0 && (
        <Column lg={16} md={8} sm={4} style={{ marginTop: "1rem" }}>
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            >
              <FormattedMessage
                id="patient.study.edit.load"
                defaultMessage="Edit Patient Study"
              />
            </Button>
          </div>
        </Column>
...
export default PatientStudyEditSearch;
