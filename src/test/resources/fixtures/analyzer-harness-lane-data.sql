...
VALUES
  ...
  (1056, 'HARN-QS7-2026-00007', '660e8400-e29b-41d4-a716-446655440056', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1057, 'HARN-QS5-2026-00001', '660e8400-e29b-41d4-a716-446655440057', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1058, 'HARN-QS5-2026-00002', '660e8400-e29b-41d4-a716-446655440058', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1059, 'HARN-QS5-2026-00005', '660e8400-e29b-41d4-a716-446655440059', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1060, 'HARN-FC-2026-00001', '660e8400-e29b-41d4-a716-446655440060', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1061, 'HARN-FC-2026-00002', '660e8400-e29b-41d4-a716-446655440061', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
  (1062, 'HARN-FC-2026-00003', '660e8400-e29b-41d4-a716-446655440062', 'H', 1,
   CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE)
...
VALUES
  ...
  (10606, 1056, 1, 'HARN-QS7-00007-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-QS7', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10607, 1057, 1, 'HARN-QS5-00001-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-QS5', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10608, 1058, 1, 'HARN-QS5-00002-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-QS5', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10609, 1059, 1, 'HARN-QS5-00005-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-QS5', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10610, 1060, 1, 'HARN-FC-00001-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-FC', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10611, 1061, 1, 'HARN-FC-00002-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-FC', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP),
  (10612, 1062, 1, 'HARN-FC-00003-TUBE', 1, CURRENT_TIMESTAMP, 'Harness-FC', 5.0, 1, FALSE, FALSE,
   CURRENT_TIMESTAMP)
ON CONFLICT (id) DO UPDATE SET
